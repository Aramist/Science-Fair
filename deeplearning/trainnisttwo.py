...
class NistNet(object):
    ...
    def build(self, train=False):
        ...
        self.pool_1 = self.max_pool(self.conv1_1, 'pool_1')
        #Output of this layer is 64x64x64

        #Conv layer 2
        self.conv2_1 = self.conv_layer(self.pool_1, 64, 128, 'conv2_1')
        self.pool_2 = self.max_pool(self.conv2_1, 'pool_2')
        #Output of this layer is 32x32x128

        #Conv layer 3
        self.conv3_1 = self.conv_layer(self.pool_2, 128, 256, 'conv3_1')
        self.pool_3 = self.max_pool(self.conv3_1, 'pool_3')
        #Output of this layer is 16x16x256

        #Conv layer 4
        self.conv4_1 = self.conv_layer(self.pool_3, 256, 512, 'conv3_1')
        self.pool_4 = self.max_pool(self.conv4_1, 'pool_3')
        #Output of this layer is 8x8x512

        self.conv5_1 = self.conv_layer(self.pool_4, 512, 1024, 'conv5_1')
        self.pool_5 = self.max_pool(self.conv5_1, 'pool_5')
        #Output of this layer is 4x4x1024

        self.conv6_1 = self.conv_layer(self.pool_5, 1024, 2048, 'conv6_1')
        self.pool_6 = self.max_pool(self.conv6_1, 'pool_6')
        #Output of this layer is nx2x2x2048

        #Fully Connected Layer 1
        self.fc_1 = self.fc_layer(self.pool_6, 2*2*2048, 4096, 'fc_1')
    ...
    def build_train_step(self):
        ...
        with tf.variable_scope('train_step'):
            ...
            self.train_step = tf.train.GradientDescentOptimizer(0.0005).minimize(self.cross_entropy)
